...
QtObject {
	...
	readonly property color fgLight: "#fbf1c7"
	readonly property color fgMedium: "#ebdbb2"
	readonly property color fgDark: "#d5c4a1"
	...
	readonly property color grayDark: "#665c54"
	readonly property color grayLight: "#a89984"

	readonly property color accent: green
	readonly property color seccondAccent: blue
}
